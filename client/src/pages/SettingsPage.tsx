...
const SettingsPage = () => {
  ...
  const handleDeleteAccount = async () => {
    if (window.confirm("This action will permanently delete your account and all associated data, including your registered email. This cannot be undone. Are you sure you want to proceed?")) {
      try {
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <Tabs defaultValue="profile" className="space-y-6">
          ...
          <TabsContent value="privacy">
            ...
            <Card className="glass-effect border-destructive/30 mt-6">
              <CardHeader>
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground mb-4">
                  Permanently delete your account and all associated data, including gigs, proposals, messages, and connections. This action cannot be undone and your registered email will be completely removed from our system.
                </p>
