            ...
            {step === 3 && (
              <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="flex space-x-2">
                      <Input
                        type="number"
                        min="1"
                        value={gigData.durationValue}
                        onChange={(e) => setGigData(prev => ({ ...prev, durationValue: e.target.value }))}
                        placeholder="e.g., 2"
                        className="w-1/2"
                      />
                      <Select 
                        value={gigData.durationUnit} 
                        onValueChange={(value) => setGigData(prev => ({ ...prev, durationUnit: value }))}
                      >
                ...
                <div className="flex justify-between">
                  ...
                  <Button
                    onClick={() => setStep(4)}
                    disabled={!gigData.minBudget || !gigData.maxBudget || !gigData.durationValue || !gigData.deadline}
                    className="glow-button"
                  >
                    Continue
                    <ArrowRight className="w-4 h-4 ml-2" />
              ...
              <div className="space-y-6">
                ...
                <Card className="border-primary/20">
                  ...
                  <CardContent className="space-y-3">
                    ...
                    <div>
                      <strong>Duration:</strong> {gigData.durationValue} {gigData.durationUnit}
                    </div>
                    <div>
